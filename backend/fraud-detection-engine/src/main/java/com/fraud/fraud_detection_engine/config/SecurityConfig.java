...
import com.fraud.fraud_detection_engine.security.ApiRateLimitFilter;
import com.fraud.fraud_detection_engine.security.JwtFilter;
...
public class SecurityConfig {
 ...
 .requestMatchers("/api/v1/fraud/stream").permitAll()
